...
\begin{center}
\tcbox[tikznode={align=left}, colframe=ehone]{
\ul{Multiscale cross-entropy functions have two positional arguments:} 
\\ \ \\
\hspace{38pt} the time series signals \texttt{\textbf{Sig}} (an Nx2 matrix), \\
\hspace{48pt} and the multiscale entropy object, \texttt{\textbf{Mobj}}. }
\end{center}
